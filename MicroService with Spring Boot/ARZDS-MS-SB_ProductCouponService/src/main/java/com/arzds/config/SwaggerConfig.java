...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Product Service").description("ArzDs Company")
				.contact(new Contact("ArzDs", "https://github.com/Dheerendrasingh12/DsArz",
						"dheerendrasingh44@yahoo.com"))
				.license("Apcahce-2.0").licenseUrl("http://www.apache.org/licence/LICESE-2.0.html").version("1.0")
				.build();
	}
}
